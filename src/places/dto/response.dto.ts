...
export class ApiResponseDto {
  @ApiProperty({
    description:
      'Whether the request was successful - true for successful operations, false for errors',
    example: true,
  })
  success: boolean;
  ...
  @ApiProperty({
    description:
      'Response message or data - contains the actual result of the operation',
  ...
  @ApiProperty({
    description:
      'Timestamp of the response in ISO format - when the response was generated',
...
export class ChatResponseDto extends ApiResponseDto {
  @ApiProperty({
    description:
      'AI agent response to the user message - natural language text generated by location intelligence agents',
...
export class SearchResponseDto extends ApiResponseDto {
  @ApiProperty({
    description:
      'Original search query from URL parameters - the raw query string provided by user',
    example: 'restaurants',
  })
  ...
  @ApiProperty({
    description:
      'Natural language message sent to agent - how the parameters were converted to natural language',
...
export class HealthResponseDto {
  @ApiProperty({
    description:
      'Health status of the service - indicates if the service is operational',
    example: 'healthy',
  })
  status: string;
  ...
  @ApiProperty({
    description:
      'Timestamp of the health check in ISO format - when the health check was performed',
    example: '2024-08-13T10:30:00.000Z',
  })
  timestamp: string;
}
...
export class ExampleCategory {
  ...
  @ApiProperty({
    description:
      'List of example queries in this category - sample queries users can try',
    example: [
...
export class ExamplesResponseDto {
  @ApiProperty({
    description:
      'Whether the request was successful - always true for examples endpoint',
    example: true,
  })
  success: boolean;
  ...
  @ApiProperty({
    description:
      'List of example categories with sample queries - organized by use case type',
  ...
  @ApiProperty({
    description:
      'Timestamp of the response in ISO format - when examples were retrieved',
    example: '2024-08-13T10:30:00.000Z',
  })
  timestamp: string;
}
